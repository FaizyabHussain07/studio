...
import { LayoutDashboard, Users, BookCopy, PenSquare, LogOut, Settings, HelpCircle, GraduationCap, UserCheck, StickyNote, Calendar, Library } from "lucide-react";
...
const adminNav = [
  ...
  { name: "Resources", href: "/dashboard/admin/resources", icon: Library },
  ...
  { name: "Requests", href: "/dashboard/admin/requests", icon: UserCheck },
];
